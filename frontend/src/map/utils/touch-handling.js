...
export class TouchHandler {
    ...
    constructor(trackedElement) {
        ...
        this.trackedElement.addEventListener("mousemove", e => {
            return this.pointerMove(e, this.touchChangesFromMouseEvent(e));
        });
        this.trackedElement.addEventListener("mouseup", e => {
            return this.pointerUp(e, this.touchChangesFromMouseEvent(e));
        });
        this.trackedElement.addEventListener("mouseleave", e => {
            return this.pointerUp(e, this.touchChangesFromMouseEvent(e));
        });
        this.trackedElement.addEventListener("mouseout", e => {
            return this.pointerUp(e, this.touchChangesFromMouseEvent(e));
        });

        this.trackedElement.addEventListener("touchstart", e => {
            return this.pointerDown(e, this.touchChangesFromTouchEvent(e));
        });
        this.trackedElement.addEventListener("touchmove", e => {
            return this.pointerMove(e, this.touchChangesFromTouchEvent(e));
        });
        this.trackedElement.addEventListener("touchcancel", e => {
