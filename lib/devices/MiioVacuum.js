...
class MiioVacuum {
    ...
    updateStatus(newState) {
        ...
        this.onStatusChange(this.robotState);
    }
     ...
     * @protected
     * @abstract
     * @param {Array<string>} changedProperties keys of the this.status object that changed. TODO
     */
    onStatusChange(changedProperties) { //TODO
        throw new NotImplementedError();
    }
