...
class Viomi extends MiioVacuum {
     ...
     * @param [options.movementMode] {ViomiMovementMode} //If unset, we'll use the current value
     * @param options.operation {ViomiOperation} //Stop/Start/Pause
     * @param [options.additionalParameters] {Array}
     *
