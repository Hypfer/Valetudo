...
const Configuration = function() {
    ...
    if(fs.existsSync(this.location)) {
        log.log("Loading configuration file:", this.location);
        ...
        try {
            ...
            log.log("Writing new file using defaults");

            this.persist();
        }
    } else {
        log.log("No configuration file present. Creating one at:", this.location);
