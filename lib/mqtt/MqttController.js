...
class MqttController {
            ...
            if (key === "mqtt") {
                ...
                await this.reconfigure(async () => {
                    ...
                    await this.robotHandle.deconfigure({
                        cleanValues: this.enabled ? true : this.cleanTopics,
                        cleanHomie: this.enabled ? true : this.homieCleanAttributes,
                        unsubscribe: this.enabled ? true : this.clean
                    });
                }, {targetState: this.enabled ? HomieCommonAttributes.STATE.INIT : HomieCommonAttributes.STATE.DISCONNECTED});
    ...
    loadConfig() {
        ...
        this.cleanTopics = mqttConfig.cleanTopicsOnShutdown;
     ...
     * @return {Promise<void>}
     */
    async withHass(callback) {
        // TODO handle configure/deconfigure as needed.
        if (this.hassEnabled) {
            await callback(null /* TODO */);
        }
    }
