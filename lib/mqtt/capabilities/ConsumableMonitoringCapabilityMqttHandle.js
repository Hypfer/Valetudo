    ...
    async addNewConsumable(topicId, attr) {
        ...
        this.registerChild(
            new PropertyMqttHandle({
                ...
                helpText: "This handle returns the consumable remaining time as percent or as an ISO8601 duration. " +
                    "The relevant Home Assistant component will report it as remaining seconds instead."
            }).also((prop) => {
