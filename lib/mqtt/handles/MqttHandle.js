...
class MqttHandle {
     ...
     * @public
     * @param {object} [options]
     * @param {boolean} [options.cleanValues] Default true
     * @param {boolean} [options.cleanHomie] Default true
     * @param {boolean} [options.unsubscribe] Default true
     * @return {Promise<void>}
     */
    ...
    async setHomie(value) {
        ...
        const converted = this.unmarshalHomie(value, this.dataType);
    ...
    marshalHomie(value, datatype) {
        ...
        switch (datatype) {
            ...
            case DataType.COLOR:
                ...
                if (datatype === DataType.ENUM && this.format.split(",").indexOf(value) < 0) {
