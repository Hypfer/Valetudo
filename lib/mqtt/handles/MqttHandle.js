...
class MqttHandle {
    /**
     * @param {{parent: import("./NodeMqttHandle"), topicName: string, friendlyName: string, getter?: getterCallback, setter?: setterCallback, datatype: import(./homie/DataType), unit?: import(./homie/Unit), format?: string, retained?: boolean} & {settable: boolean, gettable: boolean}} options
     ...
     * @param {import(./homie/DataType)} [options.datatype] Data type for this handle, if gettable/settable
     ...
     * The default implementation only refreshes children. Child classes must refresh themselves where it makes sense.
     *
     * @public
     * @return {Promise<void>}
     */
