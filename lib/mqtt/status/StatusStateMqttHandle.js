    ...
    constructor(options) {
        ...
        this.registerChild(new PropertyMqttHandle({
            ...
            getter: () => {
                ...
                HassAnchor.getAnchor(HassAnchor.ANCHOR.IS_CLEANING)
                    .post(statusState.value === stateAttrs.StatusStateAttribute.VALUE.CLEANING).then();
                HassAnchor.getAnchor(HassAnchor.ANCHOR.IS_DOCKED)
                    .post(statusState.value === stateAttrs.StatusStateAttribute.VALUE.DOCKED).then();
