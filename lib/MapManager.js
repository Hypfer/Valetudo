...
function storeMap(name, cb) {
    ...
    fs.copyFileSync("/mnt/data/rockrobo/ChargerPos.data", "/mnt/data/valetudo/maps/" + name + "/ChargerPos.data");
...
function loadMap(name, cb) {
    ...
    fs.copyFileSync("/mnt/data/valetudo/maps/" + name + "/ChargerPos.data", "/mnt/data/rockrobo/ChargerPos.data");
