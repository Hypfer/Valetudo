...
function storeMap(name, cb) {
    ...
    if (!fs.existsSync("/mnt/data/last_map")) {
    ...
    if (fs.existsSync("/mnt/data/rockrobo/PersistData_1.data")) fs.copyFileSync("/mnt/data/rockrobo/PersistData_1.data", "/mnt/data/valetudo/maps/" + name + "/PersistData_1.data");
    if (fs.existsSync("/mnt/data/rockrobo/PersistData_2.data")) fs.copyFileSync("/mnt/data/rockrobo/PersistData_1.data", "/mnt/data/valetudo/maps/" + name + "/PersistData_2.data");
    cb(null);
}
...
function loadMap(name, cb) {
    if (!fs.existsSync("/mnt/data/valetudo/maps/" + name + "/last_map")) {
        cb("floor '"+cb+"' doesn't exist");
        return;
    }
    if (fs.existsSync("/mnt/data/rockrobo/PersistData_1.data")) fs.unlinkSync("/mnt/data/rockrobo/PersistData_1.data");
    ...
    if (fs.existsSync("/mnt/data/valetudo/maps/" + name + "/PersistData_1.data")) fs.copyFileSync("/mnt/data/valetudo/maps/" + name + "/PersistData_1.data", "/mnt/data/rockrobo/PersistData_1.data");
    if (fs.existsSync("/mnt/data/valetudo/maps/" + name + "/PersistData_2.data")) fs.copyFileSync("/mnt/data/valetudo/maps/" + name + "/PersistData_2.data", "/mnt/data/rockrobo/PersistData_2.data");
