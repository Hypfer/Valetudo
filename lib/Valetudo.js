...
const Valetudo = function() {
    ...
    if(this.configuration.get("telegram_token")) {
        this.telegramClient = new Telegrambot({
            vacuum: this.vacuum,
            events: this.events,
            telegramtoken: this.configuration.get("telegram_token"),
            sendconsumables: this.configuration.get("telegram_send_consumables"),
            sendconsumablesevery: this.configuration.get("telegram_send_consumables_every")
        });
    } else {
        this.telegramClient = new Telegrambot({
            vacuum: this.vacuum,
