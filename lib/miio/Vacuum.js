...
Vacuum.prototype.getCurrentStatus = function(callback) {
    this.sendMessage("get_status", [], {}, Vacuum.GET_ARRAY_HANDLER(function(err, res){
        if(err) {
            ...
            res.human_state = Vacuum.getStateCodeDescription(res.state);
            res.human_error = Vacuum.getErrorCodeDescription[res.error_code];
            delete(res["msg_seq"]);
...
Vacuum.getErrorCodeDescription = function(errorCodeId) {
...
Vacuum.getStateCodeDescription = function(stateCodeId) {
