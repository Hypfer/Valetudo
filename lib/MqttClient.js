...
const MQTT_STATE_MAPPINGS = {
    1: MQTT_STATES.STARTING,
    2: MQTT_STATES.CHARGER_DISCONNECTED,
    3: MQTT_STATES.IDLE,
    4: MQTT_STATES.REMOTE_CONTROL_ACTIVE,
    5: MQTT_STATES.CLEANING,
    6: MQTT_STATES.RETURNING_HOME,
    7: MQTT_STATES.MANUAL_MODE,
    8: MQTT_STATES.CHARGING,
    9: MQTT_STATES.CHARGING_PROBLEM,
    10: MQTT_STATES.PAUSED,
    11: MQTT_STATES.SPOT_CLEANING,
    12: MQTT_STATES.ERROR,
    13: MQTT_STATES.SHUTTING_DOWN,
    14: MQTT_STATES.UPDATING,
    15: MQTT_STATES.DOCKING,
    16: MQTT_STATES.GOING_TO_TARGET,
    17: MQTT_STATES.ZONED_CLEANING
};
