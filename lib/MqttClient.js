...
class MqttClient {
    ...
    loadConfig() {
        ...
        this.clientCertPath = mqttConfig.clientCertPath || "";
        this.clientKeyPath = mqttConfig.clientKeyPath || "";
    ...
    connect() {
        if (!this.client || (this.client && this.client.connected === false && this.client.reconnecting === false)) {
            ...
            if (this.clientCertPath) options.cert = fs.readFileSync(this.clientCertPath);
            if (this.clientKeyPath) options.key = fs.readFileSync(this.clientKeyPath);
