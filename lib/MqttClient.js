    ...
    async updateAttributesTopic() {
        ...
        try {
            if (this.client && this.client.connected === true) {
                ...
                response.mainBrush = consumableStatus.mainBrushLeftTime.toFixed(1);
                response.sideBrush = consumableStatus.sideBrushLeftTime.toFixed(1);
                response.filter = consumableStatus.filterLeftTime.toFixed(1);
                response.sensor = consumableStatus.sensorLeftTime.toFixed(1);
