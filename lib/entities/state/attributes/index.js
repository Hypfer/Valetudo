module.exports = {
    ...
    CleanSummaryAttribute: require("./CleanSummaryAttribute"),
    CleanRecordAttribute: require("./CleanSummaryAttribute"),
    IntensityStateAttribute: require("./IntensityStateAttribute"),
