...
const FAN_SPEEDS = {
    [entities.state.attributes.IntensityStateAttribute.VALUE.MIN]: 1,
    [entities.state.attributes.IntensityStateAttribute.VALUE.LOW]: 38,
    [entities.state.attributes.IntensityStateAttribute.VALUE.MEDIUM]: 60,
    [entities.state.attributes.IntensityStateAttribute.VALUE.HIGH]: 75,
    [entities.state.attributes.IntensityStateAttribute.VALUE.MAX]: 100
};
