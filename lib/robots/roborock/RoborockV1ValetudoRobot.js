...
const FAN_SPEEDS = {
    [entities.state.attributes.PresetSelectionStateAttribute.VALUE.MIN]: 1,
    [entities.state.attributes.PresetSelectionStateAttribute.VALUE.LOW]: 38,
    [entities.state.attributes.PresetSelectionStateAttribute.VALUE.MEDIUM]: 60,
    [entities.state.attributes.PresetSelectionStateAttribute.VALUE.HIGH]: 75,
    [entities.state.attributes.PresetSelectionStateAttribute.VALUE.MAX]: 100
};
