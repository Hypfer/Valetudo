...
class RoborockValetudoRobot extends MiioValetudoRobot {
    ...
    parseAndUpdateState(data) {
        ...
        if (data["fan_power"] !== undefined) {
            ...
            if (!matchingFanSpeed) {
                matchingFanSpeed = stateAttrs.PresetSelectionStateAttribute.VALUE.CUSTOM;
            }
            ...
            this.state.upsertFirstMatchingAttribute(new stateAttrs.PresetSelectionStateAttribute({
                ...
                customValue: matchingFanSpeed === stateAttrs.PresetSelectionStateAttribute.VALUE.CUSTOM ? data["fan_power"] : undefined
            }));
        }
        ...
        if (data["water_box_mode"] !== undefined) {
            ...
            if (!matchingWaterGrade) {
                matchingWaterGrade = stateAttrs.PresetSelectionStateAttribute.VALUE.CUSTOM;
            }

            this.state.upsertFirstMatchingAttribute(new stateAttrs.PresetSelectionStateAttribute({
                type: stateAttrs.PresetSelectionStateAttribute.TYPE.WATER_GRADE,
                value: matchingWaterGrade,
                customValue: matchingWaterGrade === stateAttrs.PresetSelectionStateAttribute.VALUE.CUSTOM ? data["water_box_mode"] : undefined
            }));
        }
