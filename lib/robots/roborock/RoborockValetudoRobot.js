...
class RoborockValetudoRobot extends MiioValetudoRobot {
    ...
    constructor(options) {
        ...
        this.registerCapability(new capabilities.RoborockCleanSummaryCapability({
            robot: this
        }));
    ...
    onMessage(msg) {
        switch (msg.method) {
            ...
            case "_sync.getctrycode":
                this.sendCloud({
                    id: msg.id, result: {ctry_code: "DE"} //TODO_re
                });
                return true;
            ...
            case "event.back_to_dock": //TODO_re
            case "event.error_code":
            case "event.bin_full": //TODO_re: bring to UI
