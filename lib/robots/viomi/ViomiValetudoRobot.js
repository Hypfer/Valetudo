    ...
    parseAndUpdateState(data) {
        ...
        if (data["suction_grade"] !== undefined) {
            ...
            this.state.upsertFirstMatchingAttribute(new stateAttrs.PresetSelectionStateAttribute({
                ...
                customValue: matchingFanSpeed === stateAttrs.PresetSelectionStateAttribute.VALUE.CUSTOM ? data["suction_grade"] : undefined
            }));
        }
        ...
        if (data["water_grade"] !== undefined) {
            ...
            this.state.upsertFirstMatchingAttribute(new stateAttrs.PresetSelectionStateAttribute({
                ...
                customValue: matchingWaterGrade === stateAttrs.PresetSelectionStateAttribute.VALUE.CUSTOM ? data["water_grade"] : undefined
            }));
        }
