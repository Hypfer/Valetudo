...
class ViomiValetudoRobot extends MiioValetudoRobot {
    ...
    constructor(options) {
        ...
        this.registerCapability(new capabilities.ViomiSensorCalibrationCapability({
            robot: this,
            sensors: attributes.ViomiSensorTypes
        }));
    ...
    parseAndUpdateState(data) {
        ...
        if (
            ...
            if (data["mode"] === 5 || (previousState && previousState.value === stateAttrs.StatusStateAttribute.VALUE.MANUAL_CONTROL)) {
