...
class ViomiManualControlCapability extends ManualControlCapability {
    ...
    isInManualControlMode() {
        const state = this.state.getFirstMatchingAttributeByConstructor(stateAttrs.StatusStateAttribute);
    ...
    /**
     * @param {import(../..//entities/core/ValetudoManualControlAction)} action
     * @returns {Promise<void>}
     */
