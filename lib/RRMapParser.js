...
const BlockTypes = {
    ...
    "FORBIDDEN_ZONES": 9,
    "VIRTUAL_WALLS": 10,
    "CURRENTLY_CLEANED_BLOCKS": 11, //TODO: implement
    "DIGEST": 1024
};
...
class RRMapParser {
    ...
    static PARSE_BLOCK(block) {
        switch (block.type) {
            ...
            case BlockTypes.FORBIDDEN_ZONES:
    ...
    static PARSE_IMAGE_BLOCK(block) { //TODO: port Gen3 Support from RE
        const parsedBlock = { //Metadata
            position: {
                top: block.view.readInt32LE(0x08),
                left: block.view.readInt32LE(0x0c)
            },
            dimensions: {
                height: block.view.readInt32LE(0x10),
                width: block.view.readInt32LE(0x14)
            },
            pixels: {}
        };
                ...
                if (val !== 0) {
                    ...
                    switch (val) {
                        case 1:
                            ...
                            break;
                        case 8:
                            imageData.obstacle_weak.push(coords);
                            break;
                        case 255:
