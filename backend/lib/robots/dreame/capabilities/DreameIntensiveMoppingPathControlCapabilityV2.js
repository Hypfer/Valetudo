 ...
 */
class DreameIntensiveMoppingPathControlCapabilityV2 extends IntensiveMoppingPathControlCapability {
    ...
    async isEnabled() {
        ...
        return [2,3].includes(deserializedResponse.CleanRoute);
    }
...
module.exports = DreameIntensiveMoppingPathControlCapabilityV2;
