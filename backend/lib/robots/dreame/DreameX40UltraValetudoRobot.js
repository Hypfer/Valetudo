...
class DreameX40UltraValetudoRobot extends DreameGen4ValetudoRobot {
    ...
    constructor(options) {
        ...
        this.registerCapability(new capabilities.DreameMapAnnotationsCapability({
            ...
            miot_actions: {
                map_edit: {
                    siid: DreameX40UltraValetudoRobot.MIOT_SERVICES.MAP.SIID,
                    aiid: DreameX40UltraValetudoRobot.MIOT_SERVICES.MAP.ACTIONS.EDIT.AIID
                }
            },
            miot_properties: {
                mapDetails: {
                    piid: DreameX40UltraValetudoRobot.MIOT_SERVICES.MAP.PROPERTIES.MAP_DETAILS.PIID
                },
                actionResult: {
                    piid: DreameX40UltraValetudoRobot.MIOT_SERVICES.MAP.PROPERTIES.ACTION_RESULT.PIID
                }
            }
        }));
