...
describe("DreameMapParser", function () {
    ...
    it("Should pre-process & parse D9 FW 1093 \"huge\" map correctly", async function() {
        let data = await fs.readFile("./test/lib/DreameMapParser/d9_1093_huge.bin");
    ...
    it("Should pre-process & parse Z10 FW 1056 map with virtual restrictions correctly", async function() {
        let data = await fs.readFile("./test/lib/DreameMapParser/z10_1056_virtual_restrictions.bin");
        let expected = JSON.parse(await fs.readFile("./test/lib/DreameMapParser/z10_1056_virtual_restrictions.json", { encoding: "utf-8" }));
    ...
    it("Should pre-process & parse Z10 FW 1056 map with paths correctly", async function() {
        let data = await fs.readFile("./test/lib/DreameMapParser/z10_1056_paths.bin");
        let expected = JSON.parse(await fs.readFile("./test/lib/DreameMapParser/z10_1056_paths.json", { encoding: "utf-8" }));
