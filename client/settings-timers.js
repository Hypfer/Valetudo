    ...
    <script>
        ...
        function saveDndTimer() {
            ...
            if (start_hour && start_minute && end_hour && end_minute) {
                ...
                ons.notification.toast("Could not save DND Timer since not all required attributes are provided!", { buttonLabel: 'Dismiss', timeout: window.fn.toastErrorTimeout });
            }
        }
