...
The OTA rooting method is the easiest one requiring no disassembly. However, since Xiaomi disabled local OTA you might
need to downgrade your firmware by factory resetting your robot.
