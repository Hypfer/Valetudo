...
or Source-Engine maps](/pages/companion_apps/fun_games/). Some people have also sent out their robot to map out a new living space before moving,
...
The [getting started guide](/pages/general/getting-started/) is a good place to start.
