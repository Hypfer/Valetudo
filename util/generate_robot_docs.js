...
function generateCapabilityLink(capability) {
    return "[" + capability + "](https://valetudo.cloud/pages/usage/capabilities-overview/#" + capability + ")";
}
...
fs.writeFileSync(path.join(__dirname, "../docs/pages/usage/implementation-overview.md"), page.join("\n") + "\n")
process.exit(0);
